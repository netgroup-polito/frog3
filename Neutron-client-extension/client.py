...
class Client(object):
    ...
    #used for flowRoute edited by rbonafiglia
    flowroutes_path="/flowrules"
    flowroute_path="/flowrules/%s"
    ...
    #flowrules API edited by rbonafiglia
    @APIParamsCall
    def create_flowrule(self, body=None):
        """Create a new flowrules"""
        _logger.debug(self.flowroutes_path)
        return self.post(self.flowroutes_path, body)
    
    @APIParamsCall
    def show_flowrules(self):
        """Create a new flowrules"""
        return self.get(self.flowroutes_path)
    
    @APIParamsCall
    def show_flowrule(self, flowroute):
        """Create a new flowrules"""
        return self.get(self.flowroute_path % flowroute)
    
    @APIParamsCall
    def delete_flowrule(self, flowroute):
        """Create a new flowrules"""
        return self.delete(self.flowroute_path % flowroute)
    
    @APIParamsCall
    def update_flowrule(self, flowroute, body=None):
        """Create a new flowrules"""
        return self.put(self.flowroute_path % flowroute, body)
