...
authenticationData = {"auth": {"tenantName": "blue", "passwordCredentials": {"username": "blue", "password": "stack"}}}
...
try:
    ...
    print "ERROR - User Blue is NOT correctly instantiated"
    sys.exit()
print "User Blue is now correctly instantiated"
