...
class ISP(object):
    ...
    def addEgressSwitch(self, nf_fg):
        ...
        port_e.setFlowRuleToVNF(egress_sw, port_egress)
        port_egress.setFlowRuleToVNF(nf_fg.control_switch, port_e)
    ...
    def instatiateISP(self):
        ...
        '''
        #port_e.setFlowRuleToEndpoint(egress_sw)
        #port_e.setFlowRuleFromEndpoint(c_switch, egress_sw)
        '''
