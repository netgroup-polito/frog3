...
* 
* File: CommonServlet.java
*/

package utils.resourcesDispatcher;
...
/*
 * This servlet forwards all the non-servlet resources.
 * This is needed because the captive portal needs that index.jsp is mapped on /*,
 * and it overrides all the mappings for static resources (css,js,html,images,etc.),
 * while the mapping for other servlets is kept (because of longest prefix match).
 *  
 */
